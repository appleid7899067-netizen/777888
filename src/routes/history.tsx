  ...
  return (
    <AppShell>
      <div className="mx-auto max-w-6xl px-4 py-8">
        <p className="text-[11px] font-medium uppercase tracking-wider text-subtle">Activity</p>
        <h1 className="mt-1 text-3xl font-medium tracking-tight">History</h1>
        <p className="mt-2 text-sm text-muted">Stored in this browser only. Filter by opening a row.</p>
