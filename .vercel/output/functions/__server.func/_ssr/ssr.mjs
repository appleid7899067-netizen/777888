...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C66cGIno.mjs");
...
var manifest = { "b01eec4ae031d949d6120ad0aa199a1efa45a61de6c878711eed3aebd889a3d5": {
	functionName: "runFleet_createServerFn_handler",
	importer: () => import("./ai-6KLwYuEE.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-7TZmynW4.mjs").then((n) => n.t),
