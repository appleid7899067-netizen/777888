...
import { n as Button, t as AppShell } from "./app-shell-Blnhs3ml.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/contact-CMZ7DrtO.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: "Talk to the fleet"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-muted",
					children: "Billing, enterprise, or a stubborn bug. This prototype keeps the message in your session."
				}),
				sent ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Message recorded locally. In production this would reach support."
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
								...
								id: "sub",
								required: true,
								placeholder: "Enterprise sandbox limits"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "space-y-1.5",
