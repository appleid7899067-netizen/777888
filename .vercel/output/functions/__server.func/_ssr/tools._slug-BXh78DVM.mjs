...
import { I as ArrowRight, b as LoaderCircle, c as Sparkles, r as Upload } from "../_libs/lucide-react.mjs";
import { m as toolBySlug, p as modelById } from "./catalog-Dl9lRGb5.mjs";
import { v as Link } from "../_libs/@tanstack/react-router+[...].mjs";
import { s as require_jsx_runtime } from "../_libs/@radix-ui/react-collection+[...].mjs";
import { n as Button, o as useFleet, t as AppShell } from "./app-shell-Blnhs3ml.mjs";
import { n as extractFirstCode, t as MarkdownOutput } from "./markdown-output-BUb0UKJY.mjs";
...
import { n as Route } from "./router-7TZmynW4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/tools._slug-BXh78DVM.js
...
function ToolWorkspace({ tool }) {
	...
	const cost = modelById(modelId).credits || tool.cost;
	async function generate() {
		const model = modelById(modelId);
		if (!spend(model.credits || 1)) {
			toast.error("Out of credits — adding a prototype top-up.");
			addCredits(20);
			return;
		}
		setBusy(true);
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Drop files or a project zip — stored in this browser only." }),
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					output ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MarkdownOutput, {
						...
						children: busy ? "The fleet is writing…" : "Output lands here. Nothing leaves this browser except the prompt."
					})
				]
			})
		})]
	...
	if (!tool || tool.kind === "runner") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AppShell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "That slug is not in the fleet."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				className: "mt-6",
				asChild: true,
