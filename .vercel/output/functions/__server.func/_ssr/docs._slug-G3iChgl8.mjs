...
import { r as Route$1 } from "./router-7TZmynW4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/docs._slug-G3iChgl8.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: doc.body.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: p }, p.slice(0, 24)))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					className: "mt-10",
					variant: "secondary",
